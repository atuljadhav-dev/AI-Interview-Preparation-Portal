...
const SignUpPage = () => {
    ...
    return (
        <div className="w-full h-screen flex justify-center items-center flex-col sm:flex-row ">
            <div className="w-full h-screen flex  items-center  flex-col sm:w-6/12">
                ...
                <form
                    ...
                    className="h-[65vh] w-[85vw] sm:w-[50vh] p-5 flex items-center justify-evenly flex-col rounded-2xl border-purple-500 border  backdrop-blur-none shadow-md shadow-purple-500">
                    <input
                        type="text"
                    ...
                    <button
                        type="submit"
                        disabled={sending}
                        className="border border-gray-500  cursor-pointer px-6 py-2 sm:px-8 sm:py-2.5 rounded-md transition  hover:border-purple-500 hover:scale-[1.02]">
                        Register
                    </button>
                    <p className="">
